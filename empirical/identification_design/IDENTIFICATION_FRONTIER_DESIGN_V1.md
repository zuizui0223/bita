...
- **Sun & Huang 2015 / Pedicularis rex** — selective-D system anchor; a physical floral-associated defence manipulation selectively affects seed predation without a detected visitation effect, but no independent attraction manipulation exists.
...
The companion frontier matrix should preserve the original audit columns and add only transparent derived labels:
