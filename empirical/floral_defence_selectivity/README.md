...
> **When does a flower-associated defence or access architecture suppress antagonistic use while preserving mutualistic function, and when does the interaction switch to interference or bypass?**

The active hypothesis is **effective-domain structure**: susceptibility, dose, exposure, access route, geometry, timing, visitor function, and response stage determine whether antagonist and mutualist channels are separated, overlapping, transitional, or bypassed.

The current integrated ecological readout is:
