...
KNOWN_24_PROGRAM_RECALL = COMPLETE
...
If the frozen Q1–Q8 search fails to recover any of the pre-existing 24 direct
programs, the summary fails closed. This is a search-recall diagnostic, not a
reason to add or change queries after new-record direction screening has begun.
...
- number of pre-existing direct programs recovered;
