...
The empirical pattern is therefore a **fragmented identification frontier**: the missing information reflects design fragmentation rather than absence of relevant biology or experimental competence. The practical question for each near miss becomes which additional intervention or measurement would most reduce its remaining identified set.
