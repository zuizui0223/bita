...
At the ecological mechanism level, the evidence already answers part of the escape-route question positively. Flower-associated defences repeatedly reduce antagonist access or use, pollinator-preserving guarded states recur, and access geometry distinguishes selective, interfering and bypassable systems in the screened evidence. What remains unresolved is whether relief exceeds interference plus joint cost on one complete, compatible \(A\times D\) fitness surface. Thus the constituent mechanisms and switching architecture are empirically recovered, whereas the complete escape inequality remains a generated test.
