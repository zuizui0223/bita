...
| Selectivity window | \(\rho>\iota\) before direct joint cost | Declared oriented channel definitions | Necessary region for complementarity under non-negative joint cost; not sufficient |
