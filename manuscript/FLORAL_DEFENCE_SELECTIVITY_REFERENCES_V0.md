# BITA floral-defence selectivity focused references v0

Working focused reference pool for manuscript/MANUSCRIPT_FLORAL_DEFENCE_SELECTIVITY_V0.md.

This file is deliberately narrower than the legacy BITA reference pool. Inclusion means the source has a defined role in the refocused paper; it does not mean every source must survive the final manuscript.

## 1. Framing: reproduction–defence conflict and visitor filtering
...
## 2. Primary matched-defence / selectivity anchors

Stephenson AG (1982) Iridoid glycosides in the nectar of *Catalpa speciosa* are unpalatable to nectar thieves. *Journal of Chemical Ecology* 8:1025–1034. https://doi.org/10.1007/BF00987883
...
Wu S-M, Gao J-Y (2024) The conspicuously large bracts influence reproductive success in *Thunia alba* (Orchidaceae). *Journal of Plant Ecology* 17:rtad036. https://doi.org/10.1093/jpe/rtad036

Junker RR, Gershenzon J, Unsicker SB (2011) Floral odor bouquet loses its ant repellent properties after inhibition of terpene biosynthesis. *Journal of Chemical Ecology* 37:1323–1331. https://doi.org/10.1007/s10886-011-0043-0

Tie S, He Y-D, Lázaro A, Inouye DW, Guo Y-H, Yang C-F (2023) Floral trait variation across individual plants within a population enhances defense capability to nectar robbing. *Plant Diversity* 45:315–325. https://doi.org/10.1016/j.pld.2022.11.002
...
Data and code: Zenodo https://doi.org/10.5281/zenodo.8398202
...
Data: Dryad https://doi.org/10.5061/dryad.rn8pk0pqx

Aubert remains secondary corroborating network evidence because anonymous file-byte retrieval was blocked in the current CI environment; no BITA numerical reanalysis is claimed.

## 4. Context dependence / state switching

Kessler D, Gase K, Baldwin IT (2008) Field experiments with transformed plants reveal the sense of floral scents. *Science* 321:1200–1202. https://doi.org/10.1126/science.1160072

Kessler D, Kallenbach M, Diezel C, Rothe E, Murdock M, Baldwin IT (2015) How scent and nectar influence floral antagonists and mutualists. *eLife* 4:e07641. https://doi.org/10.7554/eLife.07641
...
Use the framing reviews/meta-syntheses to establish what is already known: herbivore and pollinator effects can interact; floral scent can filter visitor classes; herbivory can alter pollination; several ecological agents impose selection on floral traits.

Do not use those syntheses as matched-D replications.

Use primary matched systems only for claims supported by the focal source-adjudicated trait and outcome.

Use Sakhalkar 2023 for the independent community-scale access-routing result. Do not count its individual visits or plant species as matched-D study clusters.

Use Kessler 2015 as a consumer-context / legacy A×D bridge. Do not double-count it as a new primary matched-D system.

## 7. Bibliographic QA still required before submission
