# Focused bibliography for the identification-design manuscript

This bibliography is intentionally narrower than the previous Mechanism → Pattern manuscript. It contains the sources directly cited by `MANUSCRIPT_IDENTIFICATION_DESIGN.md`; broader route-synthesis references remain preserved elsewhere in the repository.

Adler LS (2008) Selection by pollinators and herbivores on attraction and defense. In: Tilmon KJ (ed.), *Specialization, Speciation, and Radiation: The Evolutionary Biology of Herbivorous Insects*. University of California Press, pp. 162–173. https://doi.org/10.1525/california/9780520251328.003.0012
...
Soper Gorden NL, Adler LS (2016) Florivory shapes both leaf and floral interactions. *Ecosphere* 7:e01326. https://doi.org/10.1002/ecs2.1326
