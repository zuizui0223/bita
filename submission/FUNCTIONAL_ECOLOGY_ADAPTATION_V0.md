...
2. We tested these predictions using four evidence layers: a deduplicated D-side route-level synthesis, a stricter matched-defence state analysis, a within-system conditionality synthesis, and two independent public-data network analyses spanning Afrotropical insect visitors and Ecuadorian bird–flower interactions.
