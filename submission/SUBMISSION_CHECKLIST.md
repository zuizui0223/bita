...
- [ ] Regenerate final Figure 2 export from the exact final submission commit if any theory/config/builder input changes after the pinned export
- [ ] Produce publication-ready PDF/EPS exports and verify final fonts/labels
...
- [ ] Apply *Theoretical Ecology* journal-specific reference formatting and full-author-list rules
...
- [x] Figure 2/3 provenance and regression tests are committed
- [ ] Full CI green on the final bibliography/figure-integration head
...
- [ ] Produce final PDF/EPS exports of all main figures
...
- [ ] Re-run final manuscript audit after final CI/formatting/export completion
...
Do not press submit until final CI, figure exports, journal-specific reference formatting, author-controlled metadata, and archival DOI/release are complete. Additional literature searching is not a default blocker unless final source verification exposes a specific coverage problem or a new direct-design candidate that materially changes a registered evidence gap.
