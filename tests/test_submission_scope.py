...
RETIRED_PATHS = [
    ...
    "examples/sign_stability_report.py",
    "docs/regime_map_model.md",
    "docs/sign_stability.md",
    ...
    "docs/global_network_backbone.md",
    ...
    "trait_architecture/part_b_evidence_capacity.py",
    ".github/workflows/part-b-pipeline.yml",
    ".github/workflows/part-b-integrity.yml",
    "examples/part_b_break_even_regime_map.py",
    ...
    "docs/PART_B_MULTILAYER_EVIDENCE_STRATEGY_V2.md",
    "docs/part_b_b5_stratum_compatibility.md",
    ...
    "scripts/build_depth_saturation_audit_coding_sheet.py",
    "scripts/build_fixed_broad_abstract_packet.py",
    "scripts/build_floral_trait_animal_response_meta_packet.py",
    "scripts/build_hierarchical_evidence_synthesis.py",
    "scripts/locate_c_d_fulltext_pages.py",
    "scripts/locate_c_d_public_source_pages.py",
    "scripts/probe_castilleja_source_access.py",
    "scripts/probe_high_information_candidate_access.py",
    "scripts/scout_c_d_public_sources.py",
    "scripts/scout_castilleja_public_sources.py",
    "scripts/screen_title_validated_dryad_documentation.py",
    "scripts/validate_parameter_envelope_bridge.py",
    "scripts/validate_public_dataset_links.py",
    ...
    ".github/workflows/build-fixed-broad-abstract-evidence.yml",
...
REQUIRED_ACTIVE_PATHS = [
    ...
    "tests/test_repository_graph_integrity.py",
