...
from scripts.plot_broad_evidence_primary_figures import main
...
def test_primary_figures_render_valid_svg(tmp_path):
    ...
    fig1 = (tmp_path / "fig1_direction_map.svg").read_text(encoding="utf-8")
    assert "mostly compatible" in fig1
    fig2 = (tmp_path / "fig2_yield_meta_analysis.svg").read_text(encoding="utf-8")
    assert "pooled 1.47" in fig2
