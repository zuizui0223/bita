# What BITA can explain, by method

## Purpose

BITA does not give one undifferentiated answer to “how do attraction and defence jointly shape fitness?” It separates the question into explanatory levels. Each method answers one level and has a declared stopping point.

The machine-readable contract is `empirical/identification_design/QUESTION_METHOD_EXPLANATION_MATRIX_V1.csv`.
...
| Biotic channel allocation | Selective 16-cell experiment | `rho_delta` and `iota_delta` | Not achieved in the screened evidence | Requires selectivity, coordinate stability and baseline handling |
