...
A reproducible **Mechanism → Pattern** study of when one focal floral attraction trait (`A`) and one focal flower-specific antagonist-reducing trait (`D`) are locally complementary or substitutable on a declared outcome scale (`W`).
